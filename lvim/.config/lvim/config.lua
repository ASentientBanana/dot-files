...
--   virtual_text = false
-- })
-- vim.keymap.set('n', 'K', vim.diagnostic.open_float({ focus = false }))
...
vim.keymap.set('v', 'C-S-V', ':call system("wl-copy", @")<CR>')
vim.keymap.set('n', 'C-S-V', ':call system("wl-copy", @")<CR>')
-- vim.keymap.set('v', 'C-S-P', ':call system("wl-paste", @")<CR>')
-- vim.keymap.set('n', 'C-S-P', ':call system("wl-paste", @")<CR>')
...
vim.keymap.set('n', ',W', swap_windows, { desc = 'Swap windows' }) -- Autocommands (https://neovim.io/doc/user/autocmd.html)
-- vim.api.nvim_create_autocmd("BufEnter", {
--   pattern = { "*.json", "*.jsonc" },
--   -- enable wrap mode for json files only
--   command = "setlocal wrap",
